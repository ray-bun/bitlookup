          ...
          <div className="container mx-auto px-4 py-16 text-center text-sm lg:px-8 lg:py-32 xl:max-w-7xl">
            <div className="space-y-10">
              <nav className="space-x-4">
                ...
                <Link target="_blank" to="https://x.com/raybunii" className="text-gray-400 hover:text-gray-800 dark:hover:text-white">
                  <svg className="bi bi-twitter-x inline-block size-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
